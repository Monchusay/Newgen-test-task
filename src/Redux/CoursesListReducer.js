...
const CoursesListReducer = (state = InitialState, action) => {
    ...
    switch (action.type) {
        case "FILTER_BY_PRICE": {
            ...
            return {
                ...state, filtratedCourses: coursesFilteredByPrice
            }
        }
        case "SORT_COURSES": {
            if (action.value === "Ascending") {
                return {
                    ...state,
                    filtratedCourses: [
                        ...state.filtratedCourses.sort((a,b) => (a.courseMinPrice - b.courseMinPrice))
                    ]
                }
            }
            if (action.value === "Descending") {
                return {
                    ...state,
                    filtratedCourses: [
                        ...state.filtratedCourses.sort((a,b) => (b.courseMinPrice - a.courseMinPrice))
                    ]
                }
            }
        }
